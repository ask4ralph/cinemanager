...
class CinemasControllerTest < ActionController::TestCase
  ...
  test "should create cinema" do
    assert_difference('Cinema.count') do
      post :create, :cinema => { :active => @cinema.active, :address => @cinema.address, :name => @cinema.name, :phone => @cinema.phone }
    end
  ...
  test "should update cinema" do
    put :update, :id => @cinema, :cinema => { :active => @cinema.active, :address => @cinema.address, :name => @cinema.name, :phone => @cinema.phone }
    assert_redirected_to cinema_path(assigns(:cinema))
  end
